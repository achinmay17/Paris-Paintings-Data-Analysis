...
#centering
newTest$year <- scale(newTest$year, center = TRUE, scale = FALSE)
newTest$Surface <- scale(newTest$Surface, center = TRUE, scale = FALSE)
```
...
According to our summary, we believe that interactions are important. In our model, the most important variable 