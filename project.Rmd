...
#        winningbiddertype:prevcoll +
#        school_pntg:Surface + Surface:mat_recode, data = newTrain) #remove landsALL:paired
...
#        discauth +   
#        winningbiddertype:prevcoll +
#        school_pntg:Surface + Surface:mat_recode, data = newTrain) #remove dealer:prevcoll
...
lm(formula = log(price) ~ dealer + year + school_pntg +
        ...
        school_pntg:Surface + Surface:mat_recode, data = newTrain) #remove winningbiddertype:prevcoll 
```
