...
#        artistliving + winningbiddertype + Surface + nfigures + engraved + 
#        prevcoll + othartist + paired + finished + lrgfont + othgenre + 
#        discauth + LF + landsALL:paired + dealer:prevcoll + 
#        winningbiddertype:prevcoll + 
#        school_pntg:Surface + Surface:mat_recode, data = newTrain) 1311

#m <- lm(formula = log(price) ~ dealer + year + school_pntg +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth + landsALL:paired + dealer:prevcoll + 
#        winningbiddertype:prevcoll + winningbiddertype:artistliving +
#        school_pntg:Surface + Surface:mat_recode, data = newTrain) #deleting ** and * diff_origin other nfigures


#m <- lm(formula = log(price) ~ dealer + year + school_pntg +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth +  dealer:prevcoll + 
#        winningbiddertype:prevcoll +
#        school_pntg:Surface + Surface:mat_recode, data = newTrain) #remove landsALL:paired nothing changes 1303
...
#        discauth +   
#        winningbiddertype:prevcoll +
#        school_pntg:Surface + Surface:mat_recode, data = newTrain) #remove dealer:prevcoll  waiting to be confirmed 1290

#m <- lm(formula = log(price) ~ dealer + year + school_pntg +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth + school_pntg:Surface + Surface:mat_recode, data = newTrain) #remove  winningbiddertype:prevcoll 1292 waiting to be confirmed again 1304

#m <-lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth +  school_pntg:Surface + Surface:mat_recode, data = newTrain) #+ diff_origin 1292 waiting to be confirmed 1:45 1284

#m <-lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin +
#       artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth +  school_pntg:Surface + Surface:mat_recode + lrgfont:landsALL, data = newTrain) #+ lrgfont:landsALL 1:35. 1289

#m <-lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin +
#       artistliving + winningbiddertype + Surface +  engraved + 
#       prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth +  school_pntg:Surface + Surface:mat_recode + lrgfont:landsALL + #winningbiddertype:prevcoll, data = newTrain) #diff_origin lrglandsall winprevcoll schedule for test 1:50 1284 195, coverage 92

#m <-lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#       discauth +  school_pntg:Surface, data = newTrain) #remove surface:mat_recode to be confirmed 1:55 1406.98

#m <-lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#       discauth +  Surface:mat_recode, data = newTrain) #remove school_pntg:Surface confirm at 2:00 1275
#m <-lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth + Surface:mat_recode +winningbiddertype:prevcoll, data = newTrain) #add winning bidder schedule to be confirm 2:05 1246 200 bias, 0.9275 14684
m <-lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin +
        artistliving + winningbiddertype + Surface +  engraved + 
        prevcoll +  paired + finished + lrgfont + othgenre + LF+
        discauth + Surface:mat_recode +winningbiddertype:prevcoll, data = newTrain) #add LF
...
To begin with, we decide to recode some variables to better represent their respective features. Besides the recode of 'shape_recode' provided by Professor, we also recode variables 'mat_recode', 'fig_mention', 'artist_living_notliving', 'history_nohistory', 'mytho_nomytho', 'finished_nofinished 
