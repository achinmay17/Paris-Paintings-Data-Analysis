...
#lm(formula = log(price) ~ dealer + year + school_pntg +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth +   
#        winningbiddertype:prevcoll +
#        school_pntg:Surface + Surface:mat_recode, data = newTrain) #remove dealer:prevcoll 1292

#lm(formula = log(price) ~ dealer + year + school_pntg +
#        artistliving + winningbiddertype + Surface +  engraved + 
#        prevcoll +  paired + finished + lrgfont + othgenre + 
#        discauth + school_pntg:Surface + Surface:mat_recode, data = newTrain) #remove  winningbiddertype:prevcoll 

m<- lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin +
        artistliving + winningbiddertype + Surface +  engraved + 
        prevcoll +  paired + finished + lrgfont + othgenre + 
        discauth +  school_pntg:Surface + Surface:mat_recode, data = newTrain) #+ diff_origin
```
