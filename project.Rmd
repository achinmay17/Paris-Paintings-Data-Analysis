...
#centering
#newTrain$year <- newTrain$year - mean(newTrain$year)
#newTrain$Surface <- newTrain$Surface - mean(newTrain$Surface)
```
...
#centering
#newTest$year <- newTest$year - mean(newTest$year)
#newTest$Surface <- newTest$Surface - mean(newTest$Surface)
```
