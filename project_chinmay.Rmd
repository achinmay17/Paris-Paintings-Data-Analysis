...
m <- lm(formula = log(price) ~ dealer + year + school_pntg + diff_origin + 
        ...
        discauth + winningbiddertype:prevcoll + dealer:school_pntg + endbuyer_history + 
        Surface:mat_recode + famous_author:Surface + dealer_author + dealer_school + endbuyer_paired, data = newTrain)
