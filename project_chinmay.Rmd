...
y <- log(y)
X = subset(newTrain, select = c(dealer, year, school_pntg, diff_origin, artistliving, winningbiddertype, Surface, engraved, prevcoll, paired, finished, lrgfont, othgenre, discauth, dealer_author, endbuyer_history, endbuyer_paired, dealer_school))

Xnew = subset(newTest, select = c(dealer, year, school_pntg, diff_origin, artistliving, winningbiddertype, Surface, engraved, prevcoll, paired, finished, lrgfont, othgenre, discauth, dealer_author, endbuyer_history, endbuyer_paired, dealer_school) )

bart_machine = bartMachine(X,y, num_trees = 100, num_burn_in = 500, num_iterations_after_burn_in = 1000)
...
#        discauth + winningbiddertype:prevcoll + dealer_author + endbuyer_history +                         #         endbuyer_paired + dealer_school +
